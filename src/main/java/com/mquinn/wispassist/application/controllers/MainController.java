...
/**
 * Main application window with map pane
 *
...
public class MainController implements Initializable, MapComponentInitializedListener {
    ...
    /**
     * Opens shortest path calculation screen
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Opens network optimisation screen
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Calls method to refresh input data for map and tables
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Calls refresh methods for map and data rendering
     */
    ...
    /**
     * Refreshes main map pane using GmapsFX method
     */
    ...
    /**
     * Called when map pane initialises, set map options and
     * place network nodes and edges
     */
    @Override
    ...
    /**
     * Places listener for map events on main map object
     *
     * @param location
     * @param resources
     */
