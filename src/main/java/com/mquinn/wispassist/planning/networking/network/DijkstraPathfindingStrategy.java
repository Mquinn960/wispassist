...
public class DijkstraPathfindingStrategy implements IPathfindingStrategy {
    ...
    /**
     * Calculate a route between two points on the graph
     *
     * @param network
     * @param startVertex
     * @param endVertex
    ...
    /**
     * Helper method to assemble the linked list of path nodes
     *
     * @param destination
     * @return
     */
    ...
    /**
     * Helper method to recursively add previous path nodes on to the path
     *
     * @param vertex
     */
    ...
    /**
     * Helper method to re-sort path vertices after recursive addition
     *
     * @param shortestPath
     * @return
     */
    ...
    /**
     * Helper method to get the closest vertex to the source
     *
     * @return
     */
